...
#include <dirent.h>
#include <pthread.h>
#include "../header/functions.h" //These are header files//

#define SUCCESS 1
#define FAILURE 0
#define nt 100

extern pthread_mutex_t lock; //Using pthread mutex lock function//
...
int main(int argc, char *argv[]) 
{
	...
	FILE *f; //Used to perform basic file operations//
	f = fopen(argv[1], "r");
	if (f == NULL)
        	return FAILURE;
    	while(1)
